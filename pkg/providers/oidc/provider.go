...
// EndpointProvider allows the endpoints to be discovered
type EndpointProvider interface {
	Endpoints() Endpoints
}

// NewProvider allows a user to perform an OIDC discovery and returns the EndpointProvider.
...
// endpointProvider holds the discovered endpoints
...
func (p *endpointProvider) Endpoints() Endpoints {
	return Endpoints{
		AuthURL:     p.authURL,
		TokenURL:    p.tokenURL,
		JWKsURL:     p.jwksURL,
