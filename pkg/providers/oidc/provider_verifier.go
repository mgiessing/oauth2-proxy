...
func getVerifierBuilder(ctx context.Context, opts ProviderVerifierOptions) (verifierBuilder, EndpointProvider, error) {
...
func (p *providerVerifier) Provider() EndpointProvider {
	return p.provider
}
